          ...
          <div class="flex flex-col gap-3">
            ...
            <div class="bg-white p-[16px_24px] rounded-[26px]">
              <label for="bca" class="flex items-center justify-between">
                ...
                <input type="radio" name="package_bank_id" value="{{$bank->id}}" id="{{$bank->id}}" class="w-5 h-5 appearance-none checked:border-[3px] checked:border-solid checked:border-white rounded-full checked:bg-[#6E5DE7] ring-2 ring-[#6E5DE7]">
              </label>
            </div>
            @endforeach
          </div>
