...
<body class="font-poppins text-black">
    <section id="content" class="max-w-[640px] w-full mx-auto bg-[#F9F2EF] min-h-screen flex flex-col gap-8 pb-[120px]">
        ...
        <form enctype="multipart/form-data" method="POST" action="{{route('front.book_payment_store',$packageBooking->id)}}" class="flex flex-col gap-8">
            @csrf
            @method("PATCH")
            ...
            <div class="bg-white p-[16px_24px] rounded-[26px] flex flex-col gap-4">
              ...
              <div class="flex flex-col gap-1">
                ...
                <div class="flex items-center justify-between">
                  <span id="total-payment" class="font-semibold text-lg tracking-[0.6px] leading-[26px]" data-value="{{$packageBooking->total_amount}}">Rp {{number_format($packageBooking->total_amount,0,',','.')}}</span>
